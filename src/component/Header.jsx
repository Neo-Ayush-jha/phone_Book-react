...
const Header = ()=>{
    return(
        <AppBar position='static' color='inherit'  sx={{fontSize:'26px',position:'fixed'}}>
            <Toolbar>
                <Typography>
                ...
                <PersonPinIcon sx={{color:'blue'}} variant='h4'/>
                <Typography sx={{fontSize:'20px'}} startIcon={<SearchIcon />}>Contacts</Typography>
                </Link>
            </Breadcrumbs>
                </Typography>
